...
from desdeo.api.models.archive import UserSavedSolutionAddress
from desdeo.api.models import SolutionAddress
...
class NIMBUSClassificationResponse(SQLModel):
    ...
    saved_solutions: list[SolutionAddress] = Field(description="The best candidate solutions saved by the decision maker.")
